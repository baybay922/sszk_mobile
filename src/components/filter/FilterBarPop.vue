    ...
    .filterbarpop {
      ...
      .main {
        ...
        .item-operation {
          ...
          padding: ~`px2rem(10)` ~`px2rem(4)` ~`px2rem(10)` ~`px2rem(4)`;
          border: 1px solid rgb(91, 149, 255);
          border-radius: 3px;
          height: 0;
          line-height: ~`px2rem(1)`;
        }
        .multi-selected {
        ...
        .filter-item {
          ...
          padding: ~`px2rem(13)` 0 ~`px2rem(5)` ~`px2rem(10)`;
        ...
        .line-style {
          .item {
            ...
            &.selected:after {
              ...
              background: url('../../images/choosing.png');
