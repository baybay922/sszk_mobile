<template>
    <div class="PurchaseBox">
      <ul>
        <li>
          <img src="../../images/activity/guestSource/1.png">
        </li>
        <li>
          <img src="../../images/activity/guestSource/2.png">
        </li>
        <li class="Purchase">
          <img src="../../images/activity/guestSource/3.png">
        ...
        <li>
          <img src="../../images/activity/guestSource/4.png">
        </li>
      </ul>
    </div>
</template>
